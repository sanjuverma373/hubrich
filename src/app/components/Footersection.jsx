...
import { Facebook, Ftlogo, Insta, Mail, Twiter } from "./Icon";


const Footersection = () => {
  return (
    <div className=" bg-[url(/assets/images/footer-bg.webp)] bg-no-repeat  bg-cover bg-center py-[40px]  md:py-[95px]">
